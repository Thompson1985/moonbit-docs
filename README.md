...
There is a specialized block called `init` function. The `init` function is special in two aspects:
...
There is another specialized block called `main` function. The `main` function is the main entrance of the program, and it will be executed after the initialization stage.
